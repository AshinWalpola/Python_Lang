...
def plot_data(array_sizes, means, highs, lows):
    ...
    plt.title('Quick Sort Computation Time vs. Array Size')
...
# Main script
file_path = '/Users/ashinwalpola/Documents/University/HAW Hamburg/IE_3/AD-Dierks/Lab/Lab02/Quick_Sort_testing.txt'
